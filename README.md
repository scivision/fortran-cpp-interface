...
Fortran `logical(C_BOOL)` is used to represent boolean values when interfacing with C and C++.
Please see the [bool Readme](./test/bool/Readme.md) for important details on using `logical(C_BOOL)` correctly.
