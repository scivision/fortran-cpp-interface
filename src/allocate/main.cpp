...
extern "C" void alloc1(float**, float**, size_t*, bool*);
extern "C" void alloc2(float**, float**, size_t*, bool*);
extern "C" void alloc3(float**, float**, size_t*, bool*);
extern "C" void alloc4(float**, float**, size_t*, bool*);
